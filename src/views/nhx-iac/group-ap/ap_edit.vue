        ...
        <el-form ref="postForm" :model="ap" :rules="rules" class="form-container">
          ...
          <div v-if="ap.wpa_version === 'enterprise'" class="field-row" :class="{'highlight' : hash === 'nasid'}">
            ...
            <div class="field-value">
              <div class="field-value-column">
                <div class="field-value-column-input">
                  <el-input v-model="ap.nasid" :disabled="!canEdit" sizi="small" />
                </div>
              </div>
            </div>
          </div>
...
<!--            <div class="field-key">-->
<!--              <span class="field-key-text">own_ip</span>-->
<!--            </div>-->
<!--            <div class="field-value">-->
<!--              <div class="field-value-column">-->
<!--                <div class="field-value-column-input">-->
...
<!--          </div>-->
          ...
          <div class="field-row" :class="{'highlight' : hash === 'mcast_rate'}">
            ...
            <div class="field-value">
              <div class="field-value-column">
                <div class="field-value-column-input">
                  <el-input :disabled="!canEdit"  v-model="ap.mcast_rate" sizi="small" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="field-row" :class="{'highlight' : hash === 'maxsta'}">
            ...
            <div class="field-value">
              <div class="field-value-column">
                <div class="field-value-column-input">
                  <el-input :disabled="!canEdit" :value="parseInt(ap.maxsta)" size="small" :min="1" :max="512" @change="modAPMaxSta" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="field-row" :class="{'highlight' : hash === 'vid'}">
            ...
            <div class="field-value">
              <div class="field-value-column">
                <div class="field-value-column-input">
                  <el-input v-model="ap.vid" :disabled="!canEdit" type="number" sizi="small" />
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  mounted() {
    ...
    //   // 从新编辑项进来
    //   this.getData(this.groupId, this.$route.params.paramsKey, true)
    // } else if (this.$route.params && this.$route.params.snapshot) {
    //   this.getData(this.$route.params.snapshot.group, this.$route.params.snapshot.paramsKey, false)
    // }
  },
  beforeDestroy() {
  ...
  methods: {
    ...
    getData() {
      ...
      //     if (key === pkey) {
      //       // res[key].key = ''
      //       res[key].paramsKey = key
      //       if (isNew) {
      //         this.hash = ''
      //         this.apCopy = _.cloneDeep(res[key])
      //         this.ap = res[key]
      //       } else {
      //         this.apCopy = res[key]
      //         this.ap = _.cloneDeep(this.$route.params.snapshot)
