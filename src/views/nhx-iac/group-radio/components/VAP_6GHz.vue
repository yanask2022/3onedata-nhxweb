...
export default {
  ...
  methods: {
    onHWModeChanged(value) {
      this.$emit('onHWModeChange', { label: `raido3_${value}`, name: 'VAP_6GHz' })
    },
    submit() {
      // TODO submit
      console.log('submit')
    ...
    getData() {
      group_get_config({
        ...
        res.raido3.paramsKey = 'radio3'
        res.raido3.group = this.$route.query.group
        this.settingsCopy = res.raido3
        this.settings = _.cloneDeep(res.raido3)
      })
    }
  }
}
