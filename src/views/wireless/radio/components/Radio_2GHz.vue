    ...
    >
      ...
      <div class="card-panel-editable-content-wrapper">
        ...
        <div class="field-row" :class="{'highlight' : hash === 'disabled'}">
          <div class="field-key">
            <span class="field-key-text">2.4GHz Wireless Radio</span>
          </div>
    ...
    'settings': {
      handler(newValue, oldValue) {
        ...
        const hasChanges = syncAllChangesToStore.apply(this, [
          // 新值
          // { paramsKey: this.paramsKey, ...newValue },
          newValue,
          // 原始值
          // { paramsKey: this.paramsKey, ...this.originalWifi[this.paramsKey] },
            ...
            return {
              ...
              data: {
                ...
                routers: [
                  ...
                  {
                    title: this.$options.name + ': ' + this.paramsKey,
