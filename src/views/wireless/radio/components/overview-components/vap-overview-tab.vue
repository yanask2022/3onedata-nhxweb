  ...
  data() {
    return {
      ...
      columns: [
        ...
        { label: 'RxByte', prop: 'noise' },
        { label: 'TxByte', prop: 'noise' },
        { label: 'RxMulti', prop: 'noise' },
        { label: 'TxMulti', prop: 'noise' },
        { label: 'RxUniCast', prop: 'noise' },
        { label: 'TxUniCast', prop: 'noise' },
        { label: 'RxBroad', prop: 'noise' },
        { label: 'TxBroad', prop: 'noise' },
      ],
      globalSettings: {
