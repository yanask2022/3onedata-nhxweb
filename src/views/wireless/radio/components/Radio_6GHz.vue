    ...
    >
      ...
      <div class="card-panel-editable-content-wrapper">
        ...
        <div class="field-row" :class="{'highlight' : hash === 'disabled'}">
          <div class="field-key">
            <span class="field-key-text">6GHz Wireless Radio</span>
          </div>
...
export default {
  ...
  computed: {
    ...
    channel_width_arr() {
      if (this.settings.hwmode === '11a') {
        ...
        return ['auto', 'HT20', 'HT40', 'HT40-', 'HT40+', 'HT80', 'HT80_80', 'HT160', 'HT320']
  ...
  methods: {
    ...
    getData(callback) {
      ...
      //     if (key.startsWith('radio') && value.freq === '6G') {
      //       this.settingsCopy = lodash.cloneDeep({ ...value, paramsKey: key })
      //       this.settings = { ...value, paramsKey: key }
      //     }
      //   }
      //   const { radio3 } = res
      //   if (radio3) {
      //     this.settingsCopy = lodash.cloneDeep({ ...radio3, paramsKey: 'radio3' })
      //     this.settings = { ...radio3, paramsKey: 'radio3' }
      //   }
      //
      //   if (radio0.freq === '5G') {
      //     this.settingsCopy = lodash.cloneDeep({ ...radio0, paramsKey: 'radio0' })
      //     this.settings = { ...radio0, paramsKey: 'radio0' }
      //   } else if (radio1.freq === '5G') {
      //     this.settingsCopy = lodash.cloneDeep({ ...radio1, paramsKey: 'radio·' })
      //     this.settings = { ...radio1, paramsKey: 'radio1' }
      //   }
      // })
    }
  }
